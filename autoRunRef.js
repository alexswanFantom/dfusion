...
const readMnemonicsFromFile = (filePath) => {
...
const main = async () => {
  ...
  const mnemonics = await readMnemonicsFromFile("mnemonic.txt");
  ...
  for (const mnemonic of mnemonics) {
    try {
      ...
      logger.error(`Error processing mnemonic "${mnemonic}": ${error.message}`);
    }
  }
